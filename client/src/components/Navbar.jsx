...
<div className='flex items-center gap-6 sm:hidden'>
  ...
  {user ? (
    <div className='relative group'>
      <img src={assets.profile_icon} className='w-10 cursor-pointer' alt="User" />
    ...
    <img src={assets.menu_icon} alt='menu' />
      ...
      {open && (
        ...
        >
          ...
          <div className="flex flex-col items-start gap-4 px-6 py-8 text-lg">
            ...
            {user && (
              <NavLink to="/my-orders" onClick={() => setOpen(false)} className="hover:text-primary">
                My Orders
              </NavLink>
            )}
            <NavLink to="/contact" onClick={() => setOpen(false)} className="hover:text-primary">
              Contact
            </NavLink>
            {!user ? (
              <button
                ...
                className="cursor-pointer px-6 py-2 mt-4 bg-primary hover:bg-primary-dull transition text-white rounded-full text-sm"
              >
                Login
              </button>
            ) : (
